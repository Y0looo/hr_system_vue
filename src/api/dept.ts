...
export const getAllDept = async (curPage: number, pageSize: number, name: string) => {
  var config = {
    method: 'get',
    url: `http://localhost:9090/dept/getAllDept?curPage=${curPage}&pageSize=${pageSize}&name=${name}`,
    headers: { }
  };
