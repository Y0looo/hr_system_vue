...
export const getAllStaff = async (curPage: number, pageSize: number, name: string) => {
  var config = {
    method: 'get',
    url: `http://localhost:9090/staff/getAll?curPage=${curPage}&pageSize=${pageSize}&name=${name}`,
    headers: { }
  };
